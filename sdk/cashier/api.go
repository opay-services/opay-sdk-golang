...
func ApiCashierInitializeReq(req *CashierInitializeReq, mConf *conf.OpayMerchantConf, opts ...util.HttpOption) (
	ret CashierInitializeResp, err error) {
...
func ApiCashierCloseReq(req *CashierCloseReq, mConf *conf.OpayMerchantConf, opts ...util.HttpOption) (
	ret CashierCloseResp, err error) {
